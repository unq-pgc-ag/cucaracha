...
function checkNumericExpr(ast, context) {
  return determineTypeOf(ast.expr1, context) == 'Int' && determineTypeOf(ast.expr2, context) == 'Int';
}
...
TypeCheckFunctions = {
  ...
  "StmtVecAssign" : function(ast, context) {
    return context.locals[ast.id] == 'Vec' && determineTypeOf(ast.expr1) == 'Int' && determineTypeOf(ast.expr2) == 'Int';
  },
  ...
  "ExprVecMake" : function(ast, context) {
    ...
    var expresionesDevuelvenInt = ast.exprs.reduce(function (res, e) { return res && determineTypeOf(e, context) == 'Int'; }, true);
