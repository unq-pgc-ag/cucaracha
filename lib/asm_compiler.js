...
CompileNodesFunctions = {
  ...
  "ExprAdd" : function (ast, context) {
    ...
    context.availableRegisters = originalRegisters;
    var end = [ asmBuilder.add(originalRegisters[0], originalRegisters[1]) ];
  ...
  "ExprSub" : function (ast, context) {
    ...
    var second = compile(ast.expr2, context);
    context.availableRegisters = originalRegisters;
    var end = [ asmBuilder.sub(originalRegisters[0], originalRegisters[1]) ];
    return first.concat(second).concat(end);
  },
  ...
  "ExprMul" : function (ast, context) {
    ...
    var second = compile(ast.expr2, context);
    context.availableRegisters = originalRegisters;
    var end = [ asmBuilder.mul(originalRegisters[0], originalRegisters[1]) ];
    return first.concat(second).concat(end);
  },
  ...
  "ExprAnd" : function (ast, context) {
    ...
    var second = compile(ast.expr2, context);
    context.availableRegisters = originalRegisters;
    var end = [ asmBuilder.and(originalRegisters[0], originalRegisters[1]) ];
    return first.concat(second).concat(end);
  },
  ...
  "ExprOr" : function (ast, context) {
    ...
    var second = compile(ast.expr2, context);
    context.availableRegisters = originalRegisters;
    var end = [ asmBuilder.or(originalRegisters[0], originalRegisters[1]) ];
    return first.concat(second).concat(end);
  },

  "ExprNot" : function (ast, context) {
    var first = compile(ast.expr, context);
    var end = [ asmBuilder.not(context.availableRegisters[0]) ];
  ...
  "StmtIfElse" : function (ast, context) {
    ...
    return condicion.concat(
      ...
      [ asmBuilder.jmp('.label_fin_' + labelNumber.toString()), asmBuilder.label('.label_else_' + labelNumber.toString()) ]
